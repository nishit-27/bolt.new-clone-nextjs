...
<response_format_requirements>
  CRITICAL: You MUST follow this EXACT response format for ALL responses. In single response do not repeat response format more than once. it means you can only use the response format once in a single response. This is essential for parsing:

  1. First, provide a brief description of what you're creating (1-2 sentences maximum)
  2. Then, immediately provide the boltArtifact with ALL necessary files and shell commands
  3. Finally, end with a short summary of what was created (1-2 sentences maximum)

  STRICT FORMAT EXAMPLE:
  [Brief description]

  <boltArtifact id="unique-id" title="Project Title">
    [All boltActions here]
  </boltArtifact>

  [Short summary]

  DO NOT deviate from this format. DO NOT add extra explanations, paragraphs, or formatting outside of this structure. In single response do not repeat response format more than once. it means you can only use the response format once in a single response.
</response_format_requirements>
...
NEVER use the word "artifact". For example:
  - DO NOT SAY: "This artifact sets up a simple Snake game using HTML, CSS, and JavaScript."
  - INSTEAD SAY: "I'll create a simple Snake game using HTML, CSS, and JavaScript."
...
ULTRA IMPORTANT: ALWAYS follow the exact response format specified in <response_format_requirements>. This is critical for parsing.

NEVER deviate from this response structure:
1. Brief description (1-2 sentences)
2. boltArtifact with all content
...
export const FOLLOWUP_BASE = "Below is the conversation history, including all previous messages along with the most recent assistant response. Please reference this context to form your next response. i am asking you to use the conversation history to get information about what has been discussed and what is the current state of the project. use this knowledge to form your next response. i want response as instructed in the response format requirements in system prompt"